...
do
  require('mason-tool-installer').setup {
    ...
    ensure_installed = {
      ...
      'autopep8',
      'css-lsp',
      'diagnostic-languageserver', 'djlint', 'dockerfile-language-server',
      'elixir-ls', 'elm-format', 'elm-language-server', 'emmet-ls',
      'flake8',
      'gitlint', 'gofumpt', 'goimports', 'gopls', 'gotests', 'gotestsum',
      'haskell-language-server', 'html-lsp',
      'iferr',
      'jedi-language-server', 'json-lsp',
      'lua-language-server', 'luacheck',
      'markdownlint',
      'prettierd', 'pylint', 'python-lsp-server',
      'revive',
      'semgrep', 'solargraph', 'standardrb', 'staticcheck', 'stylua',
      'tailwindcss-language-server',
      'vim-language-server',
      'yaml-language-server', 'yamlfmt', 'yamllint', 'yapf',
    },
  }
end
