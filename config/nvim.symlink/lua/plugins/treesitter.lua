...
return {
	{
		...
		dependencies = {
			...
			{ "nvim-treesitter/nvim-treesitter-textobjects", config = textobjects_config },
			{ "nvim-treesitter/nvim-treesitter-refactor", config = refactor_config },
			{ "HiPhish/nvim-ts-rainbow2", config = rainbow_config },
		},
	},
}
