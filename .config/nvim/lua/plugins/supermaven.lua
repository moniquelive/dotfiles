...
return {
	...
	config = function(_, opts)
		...
		vim.api.nvim_create_user_command("SupermavenTrigger", function() trigger_supermaven() end, {})
		...
		vim.api.nvim_create_autocmd({ "CursorMovedI", "TextChangedI", "InsertLeave" }, {
			...
			callback = function() require("supermaven-nvim.completion_preview").on_dispose_inlay() end,
		})
	end,
}
